...
valor_conta_brl = float(input("Digite o valor total da compra: ")) 	# prefiro camel, só pra expôr meu incômodo


if valor_conta_brl < 200:	
	valor_desconto_brl = valor_conta_brl * 0.05			# desconto de 5%
elif valor_conta_brl < 300:									# cadê o "else if", alguém tava com muita preguiça pra fazer isso
